...
export default function Wish() {
  ...
  return (
    <div className="py-20 px-10 bg-neutral-200">
      ...
      <h2 className="font-montserrat text-center text-2xl text-neutral-800 mb-1">
        Ucapan dan Doa Restu
      </h2>
      <p className="font-merriweather text-center text-xs px-10 mb-8">
      ...
      <div className="border rounded-sm">
        <div className=" bg-neutral-800 p-4">
          <form onSubmit={handleSubmit} className="mx-auto mb-6 space-y-2 text-sm">
            <input
              type="text"
              placeholder="Nama"
              value={name}
            ...
            <button
              type="submit"
              className="bg-white py-0.5 px-1 rounded-full w-1/4 text-sm shadow-sm"
            >
              Kirim
            </button>
          </form>
